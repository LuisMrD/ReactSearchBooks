...
class Books extends Component {
    ...
    onChangePage(pageOfItems) {        
        ...
        // this.setState({currentPage: this.state.pagerInfo[this.state.pagerInfo.length -1]})

        // alert(JSON.stringify(this.state.pageOfItems))

        // alert(this.state.currentPage)
        // alert(JSON.stringify(this.state.pagerInfo));


        let renderBooks = {}
        switch(this.state.pageOfItems){
            case 0:
